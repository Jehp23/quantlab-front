    ...
    <div className="min-h-screen">
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        <div className="card p-8 text-center">
          <h1 className="text-2xl font-extrabold text-gray-900 mb-4">Estadísticas Avanzadas</h1>
          <p className="text-gray-500 mb-6">
            Próximamente: análisis estadístico avanzado, distribuciones, correlaciones y más métricas.
          </p>
          <Link
            href="/lab/analysis"
